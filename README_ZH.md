...
- macOS：下载 `tuzi-switch-macos-aarch64.dmg`
...
安装指定版本：
```
curl -fsSL https://raw.githubusercontent.com/AiW520/tuzi-switch/main/scripts/install_tuzi_switch.sh | TUZI_SWITCH_TAG=v1.2.7 bash
```
```
open "/Applications/兔子switch.app"
```
...
- 默认安装当前最新 Release；指定 `TUZI_SWITCH_TAG` 可安装固定版本
